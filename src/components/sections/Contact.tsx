    ...
    <>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 mb-5">
                  ...
                  <span className="text-sm font-medium tracking-[0.2em] uppercase text-[#C4A46B]">Ressource gratuite</span>
                </div>
                ...
                <p className="text-lg text-[#9AABB8] leading-[1.75] mb-6">
                ...
                <div className="flex gap-3">
                  <input type="email" placeholder="Votre email professionnel"
                    className="flex-1 glass rounded-xl px-4 py-3 text-lg text-[#EDE9E3] placeholder:text-[#9AABB8]/50 outline-none focus:border-[#C4A46B] border border-white/10 focus:border-[#C4A46B] transition-colors" />
                  <button className="px-6 py-3 rounded-xl bg-[#C4A46B] text-[#0C1B2E] text-lg font-semibold hover:bg-[#D4B47B] transition-colors cursor-pointer whitespace-nowrap">
                    Recevoir
                  </button>
                </div>
                <p className="text-lg text-[#9AABB8]/50 mt-2">Reçu immédiatement. Pas de séquence commerciale automatique.</p>
              </div>

              <div className="glass rounded-2xl p-7">
                <div className="text-sm font-medium tracking-[0.16em] uppercase text-[#C4A46B] mb-5">Aperçu · 3 des 7 signaux</div>
                <div className="flex flex-col gap-5">
                  {[
                    ...
                    <div key={i} className="flex gap-3 text-lg text-[#9AABB8] leading-[1.6]">
                      <span className="font-display text-[#C4A46B] flex-shrink-0 font-light text-lg leading-none mt-0.5">{i + 1}.</span>
                      {s}
                    </div>
                  ))}
                  <p className="text-sm text-[#9AABB8]/50 italic pt-2 border-t border-white/5">+ 4 autres signaux dans la checklist complète…</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div>
              <div className="inline-flex items-center gap-2 mb-5">
                <div className="h-px w-8 bg-[#C4A46B]" />
                <span className="text-sm font-medium tracking-[0.2em] uppercase text-[#C4A46B]">Premier contact</span>
              </div>
              ...
              <p className="text-lg text-[#9AABB8] leading-[1.9] mb-4">
              ...
              <p className="text-lg text-[#9AABB8] leading-[1.9] mb-10">
              ...
              <div className="flex flex-col gap-3 mb-10">
                {["Réponse sous 24h ouvrées", "Disponible immédiatement pour démarrer", "Sans engagement ni relance commerciale", "Paris et périphérie · déplacements possibles"].map((item) => (
                  <div key={item} className="flex items-center gap-3 text-lg text-[#9AABB8]">
              ...
              <div className="glass rounded-xl px-6 py-4 mb-5">
                <div className="text-sm font-medium tracking-[0.16em] uppercase text-[#C4A46B] mb-3">Autres façons de contacter Agnès</div>
                <div className="flex gap-5">
                  <a href="mailto:adgenevois@gmail.com" className="text-lg text-[#C4A46B] hover:text-[#D4B47B] transition-colors cursor-pointer">Email direct</a>
                  <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-lg text-[#C4A46B] hover:text-[#D4B47B] transition-colors cursor-pointer">LinkedIn</a>
                </div>
              </div>

              <p className="text-sm text-[#9AABB8]/60 leading-[1.7]">
            ...
            <div className="glass rounded-2xl p-7 sm:p-9 relative overflow-hidden">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#C4A46B]/15 border border-[#C4A46B]/30 mb-7">
                ...
                <span className="text-lg font-medium text-[#C4A46B] tracking-wide">Diagnostic gratuit · 30 min</span>
              </div>
              ...
              <div className="flex flex-col gap-5">
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={f.label}>
                      <label className="block text-lg font-medium tracking-[0.14em] uppercase text-[#9AABB8] mb-1.5">{f.label}</label>
                      <input type={f.type} placeholder={f.placeholder}
                        className="w-full glass rounded-lg px-3 py-2.5 text-lg text-[#EDE9E3] placeholder:text-[#9AABB8]/40 outline-none border border-white/8 focus:border-[#C4A46B]/50 transition-colors" />
                    </div>
                  ))}
                </div>
                ...
                <div>
                  <label className="block text-lg font-medium tracking-[0.14em] uppercase text-[#9AABB8] mb-1.5">Effectif</label>
                  <select className="w-full glass rounded-lg px-3 py-2.5 text-lg text-[#EDE9E3] outline-none border border-white/8 focus:border-[#C4A46B]/50 transition-colors cursor-pointer bg-transparent">
                ...
                <div>
                  <label className="block text-lg font-medium tracking-[0.14em] uppercase text-[#9AABB8] mb-1.5">Votre situation en 2 lignes</label>
                  <textarea rows={3} placeholder="Décrivez brièvement votre contexte RH actuel…"
                    className="w-full glass rounded-lg px-3 py-2.5 text-lg text-[#EDE9E3] placeholder:text-[#9AABB8]/40 outline-none border border-white/8 focus:border-[#C4A46B]/50 transition-colors resize-none" />
                </div>

                <button type="button"
                  className="w-full bg-[#C4A46B] text-[#0C1B2E] text-lg font-semibold tracking-wide py-4 rounded-xl hover:bg-[#D4B47B] hover:shadow-lg hover:shadow-[#C4A46B]/25 transition-all duration-200 cursor-pointer">
                  Envoyer ma demande
                </button>

                <p className="text-lg text-[#9AABB8]/50 text-center leading-[1.6] border-t border-white/5 pt-3">
      ...
      <section id="faq" className="py-24 relative">
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="inline-flex items-center gap-2 mb-5">
            <div className="h-px w-8 bg-[#C4A46B]" />
            <span className="text-sm font-medium tracking-[0.2em] uppercase text-[#C4A46B]">Questions fréquentes</span>
          </div>
          ...
          <div className="flex flex-col gap-3 max-w-3xl">
            {faqs.map((faq, i) => (
              <details key={i} className="glass rounded-2xl group overflow-hidden">
                <summary className="flex justify-between items-center px-6 py-5 text-lg font-semibold text-[#EDE9E3] cursor-pointer hover:text-[#C4A46B] transition-colors list-none gap-5">
                  {faq.q}
                ...
                <p className="px-6 pb-5 text-lg text-[#9AABB8] leading-[1.85]">{faq.r}</p>
              </details>
            ))}
          </div>
        </div>
